...
namespace AcceptanceTests.Steps
{
    ...
    public class ComprarMembresiaSteps
    {
        ...
        public void WhenEsteQuieraProlongarSuSuscripcionSeDirigiraALaOpcionMiPerfil()
        {
            ScenarioContext.Current.Pending();
        }

        [Then(@"en la sección de status de la membresía, el docente podrá seleccionar la opción “Renovar Membresía”")]
        public void ThenEnLaSeccionDeStatusDeLaMembresiaElDocentePodraSeleccionarLaOpcionRenovarMembresia()
        {
            ScenarioContext.Current.Pending();
        }
        ...
        public void ThenSeLeMostraraElStatusDeSuMembresiaConLaOpcionDeCancelarMembresia()
        {
            ScenarioContext.Current.Pending();
        }
