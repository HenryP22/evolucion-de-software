...
namespace AcceptanceTests.Steps
{
    ...
    public class GuardarDocenteFavoritoSteps
    {
        ...
        public void GivenElPadreDeFamiliaLogueadoEnLaAplicacionCuandoIngreseALaOpcionBuscarClasesYEncuentraAUnDocenteDeSuAgrado()
        {
            ScenarioContext.Current.Pending();
        }

        [When(@"ingrese a la opción “buscar clases” y encuentra a un docente de su agrado")]
        public void WhenIngreseALaOpcionBuscarClasesYEncuentraAUnDocenteDeSuAgrado()
        {
            ScenarioContext.Current.Pending();
        }
        ...
        public void WhenIngreseALaSeccionTutoriasYSeleccioneElFiltroFavoritos()
        {
            ScenarioContext.Current.Pending();
        }
